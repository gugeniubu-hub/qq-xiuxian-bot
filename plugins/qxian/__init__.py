...
sect_cmd = on_command("宗门帮助", aliases={"宗门设计", "sect_help"})
market_cmd = on_command("坊市帮助", aliases={"坊市设计", "market_help"})
rebirth_help_cmd = on_command("轮回帮助", aliases={"转世帮助", "轮回设计", "rebirth_help"})
...
leave_meditation_cmd = on_command("出关", aliases={"结束闭关", "leave"})
consume_cmd = on_command("服用", aliases={"吃药", "use"})
insight_cmd = on_command("参悟", aliases={"悟道", "insight"})
ancient_trial_cmd = on_command("古藏试炼", aliases={"古藏", "轮回试炼", "trial"})
alchemy_cmd = on_command("炼丹", aliases={"炼药", "alchemy"})
duel_cmd = on_command("斗法", aliases={"pk", "PK", "duel"})
market_list_cmd = on_command("坊市", aliases={"市场", "market"})
market_create_cmd = on_command("坊市上架", aliases={"上架", "sell"})
market_buy_cmd = on_command("坊市购买", aliases={"购买", "buy"})
ranking_cmd = on_command("排行", aliases={"排行榜", "rank"})
recent_cmd = on_command("最近记录", aliases={"行动记录", "最近战报", "log"})
